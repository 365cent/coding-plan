...
export default function Page() {
  return (
    <main id="main-content" aria-label="AI Coding Plan 对比列表" className="min-h-screen bg-background">
      <TopFloatingHeader />
      <Hero />
      ...
      <div className="max-w-7xl mx-auto px-6 pb-6">
        <div id="faq" className="mt-2 p-4 rounded-xl bg-accent border border-border flex items-start gap-3">
      ...
      <section id="about" className="max-w-7xl mx-auto px-6 mt-8">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          本站持续追踪国内主流AI Coding Plan（AI编程订阅套餐）的最新定价与功能变化，覆盖阿里云百炼、字节跳动火山方舟、京东云JoyBuilder、腾讯云、百度千帆、华为云、智谱AI、月之暗面Kimi、MiniMax、无问芯穹、摩尔线程、快手、UCloud、科大讯飞、联通云等平台。数据会随平台公告更新，购买前请以官网为准。
        </p>
