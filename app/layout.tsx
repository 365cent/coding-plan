...
const description =
  "国内AI Coding Plan（AI编程套餐）性价比对比，2026年持续更新：覆盖阿里云百炼、字节火山方舟、腾讯云、智谱GLM、Kimi、MiniMax、华为云、天翼云、Unity团结引擎等22家平台，逐项对比月付/年付价格、可用模型、用量限制、首月优惠与每元请求数，并给出性价比排行，帮你快速选出最划算的国内AI编程订阅方案。"
