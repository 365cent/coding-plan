...
export const plans: Plan[] = [
  ...
  },
  {
    ...
    toolCount: 9,
    tags: ["Credits计量", "个人版+团队版", "Harness工具", "华北2北京"],
  },
  {
    id: "ark",
    company: "字节跳动",
  ...
  },
  {
    ...
    logo: { src: "/logos/volcengine.png", alt: "火山引擎" },
    notice:
      "面向个人用户，采用 Agent 燃料值（AFP）统一计量；支持文本、图像、视频、语音及 Harness（豆包搜索、Agent 记忆等）。套餐额度仅在 AI 工具中生效，不可用于普通 API 调用。Small 不支持视频生成，建议 Medium 及以上。2026/6/10–8/8 glm-5.2 抵扣系数享 2.5 折。",
    models: [
    ...
    tiers: [
      {
        ...
        notes: "轻量化体验，不支持视频生成；视觉模型日额度 10,000 AFP（仅图片）；建议 1 个项目",
      },
      {
        name: "Medium",
        price: 200,
        ...
        notes: "支持 Kimi-K3 及视频生成；豆包搜索 500 次/月；视觉日额度 50,000 AFP；建议 1–2 个项目",
      },
      {
        name: "Large",
        price: 500,
        ...
        notes: "支持 Seedance 2.0 系列视频；豆包搜索 500 次/月；视觉日额度 125,000 AFP；建议 2+ 个项目",
      },
      {
        name: "Max",
        price: 1000,
        ...
        notes: "顶配额度；支持 Seedance 2.0 系列视频；豆包搜索 500 次/月；视觉日额度 250,000 AFP",
      },
    ],
    billingUnit: "积分制",
    tools: [
    ...
    toolCount: 10,
    tags: ["Agent Plan", "AFP积分", "全模态", "豆包搜索", "Harness"],
  },
  {
    id: "huawei",
    company: "华为云",
