...
export const plans: Plan[] = [
  ...
  },
  {
    id: "minimax",
    company: "MiniMax",
    product: "MiniMax Coding Plan",
    category: "御三家",
    links: {
      official: "https://platform.minimaxi.com/subscribe/coding-plan",
      affiliate: "https://platform.minimaxi.com/subscribe/coding-plan?code=uQkm#YTxQ#SGio4O&source=link",
    },
    ...
    billingUnit: "请求次数",
    tools: ["Claude Code", "Roo Code", "Kilo Code", "Cline", "Codex CLI", "Cursor"],
    toolCount: 10,
    tags: ["最低价", "100+ TPS"],
  },
  {
