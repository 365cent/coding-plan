...
export const plans: Plan[] = [
  ...
  },
  {
    ...
    notice:
      "新版计费已生效：Lite/Standard/Pro/Max 月度 Credits 提升至 41亿/110亿/380亿/820亿；MiMo-V2-Pro 与 MiMo-V2-Omni 不参与调整且将下线，建议切换 V2.5 系列。",
    models: [
      "MiMo-V2.5-Pro",
      "MiMo-V2.5",
    ...
    tiers: [
      {
        ...
        period: "月",
        limit5h: "-",
        limitMonth: "41亿 Credits",
        notes: "定价不变，Credits 大幅提升",
      },
      {
        name: "Standard",
        price: 99,
    ...
    tiers: [
      {
        ...
        limitWeek: "$30 / 周",
        limitMonth: "$60 / 月",
        notes: "官方为用量上限（美元）口径；各模型请求数仅为预估，可充值",
      },
    ],
    billingUnit: "按量计费",
