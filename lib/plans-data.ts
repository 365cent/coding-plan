...
export const plans: Plan[] = [
  ...
  },
  {
    ...
    notice:
      "官方未公开模型列表 API，本站模型 ID 为人工维护，可能与官网展示略有出入。API Ping 测试模型不可用，但聊天/回复场景可正常使用。订阅须通过手机端「天翼云电脑」App：进入「我的 token」后下滑至 Coding Plan 订购。套餐开通后暂不支持退订。",
    models: [
