    ...
    tiers: [
      {
        ...
        period: "月",
        limit5h: "-",
        limitMonth: "35M tokens",
        notes: "个人版体验套餐；约 70 轮问答；页面标注限时特惠以官网为准",
      },
      {
        name: "Standard",
        price: 99,
        period: "月",
        limit5h: "-",
        limitMonth: "100M tokens",
        notes: "个人版基础套餐；约 200 轮问答",
      },
      {
        name: "Pro",
        price: 299,
        period: "月",
        limit5h: "-",
        limitMonth: "320M tokens",
        notes: "个人版进阶套餐；适合高频使用；页面标注限时特惠以官网为准",
      },
      {
        name: "Max",
        price: 599,
