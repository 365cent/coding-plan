    ...
    tiers: [
      {
        ...
        notes: "基础使用：更多 Agent 积分；含 Kimi Code、Deep Research、网页部署、插件与 Kimi Work 定时任务",
      },
      {
        name: "Moderato",
        price: 99,
        ...
        notes: "进阶流程：2× Agent 积分、Kimi Code 4× 积分；含 Agent Swarm、插件与 Kimi Work 定时任务",
      },
      {
        name: "Allegretto",
        price: 199,
        ...
        notes: "专业选择：4× Agent 积分、Kimi Code 20× 积分；支持多任务、Kimi Claw、Agent Swarm 与定时任务",
      },
      {
        name: "Allegro",
        price: 699,
        ...
        notes: "高级模式：10× Agent 积分、Kimi Code 60× 积分；Agent 并发 4，含 Kimi Claw、Agent Swarm 与定时任务",
      },
    ],
    billingUnit: "Token计费",
